...
public class Categories_Ecom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.categories_ecom_main);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Categories_Ecom.this, R.layout.spinner_item, R.id.spinner_text, list);
